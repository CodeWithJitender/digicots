...
function KeywordsSection() {
  ...
  return (
    ...
    >
      <div ref={marqueeRef}>
        <div className="h-[5vh] absolute md:top-0 top-[3.1vh]  overflow-hidden">
        ...
        <div className="h-[5vh] absolute md:top-[5vh] top-[5vh] z-[2]  overflow-hidden">
          <div className="relative md:top-[-100%] top-[-37%] whitespace-nowrap animate-marquee flex items-center gap-6 text-[#fff] font-bold md:text-6xl pb-10">
            <span>Creativity</span>
