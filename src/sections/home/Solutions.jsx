    ...
    <section className="solution">
      <div className="container-xxl ">
        ...
        <div className="solution-content-conainer mt-5 bg-[#202020] rounded-3xl py-8 md:py-24 px-5 md:px-10">
          <div className="solution-content grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-5">
            <div className="sol-content-left">
              <img src="" alt="" className="w-full" />
            </div>
            <div className="sol-content-right">
              <h3 className="font-bold text-white text-4xl mb-3 font-inter">
                Strategy & Vision Crafting
              </h3>
              <h5
