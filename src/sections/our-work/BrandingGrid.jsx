  ...
  return (
    ...
    >
      ...
      <div className="py-4">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">{card.title}</h2>
...
const PopupModal = ({ card, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-end justify-center bg-black bg-opacity-60 backdrop-blur-md z-50 px-4 ">
      <div className="bg-white rounded-lg rounded-b-none w-full max-w-[1400px] p-6 relative shadow-xl ">
        ...
        <div className="max-h-[500px] overflow-y-scroll popup-container">
        ...
        <div className="grid md:grid-cols-3 md:justify-items-center mt-4 py-10 gap-10 px-3">
          ...
          <div className="h-full flex flex-col justify-between ">
            <p className="text-2xl font-bold">
              Complexity:{" "} <br />
              <span className="text-gray-600 text-[18px]">{card.complexity}</span>
            </p>
            <p className="text-2xl font-bold">
              Time Taken:{" "} <br />
              <span className="text-gray-600 text-[18px]">{card.timeTaken}</span>
            </p>
          </div>
          <div>
