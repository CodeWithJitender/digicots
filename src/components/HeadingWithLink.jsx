...
function HeadingWithLink({head, per, linkh, link}) {
  return (
    <div className='flex items-center justify-between'>
        ...
        <div className="right"><Link to={link} className='flex text-4xl font-semibold items-center'>{linkh} <i className="fal fa-arrow-up rotate-45 text-[#DF782B] ml-3"></i></Link></div>
    </div>
  )
}
