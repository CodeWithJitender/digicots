...
function HeadingWithLink({head, per, linkh, link}) {
  return (
    <div className='flex items-center justify-center md:justify-between'>
        ...
        <div className="right hidden lg:block"><Link to={link} className='flex text-4xl font-semibold items-center'>{linkh} <i className="fal fa-arrow-up rotate-45 text-[#ED510C] ml-3"></i></Link></div>
    </div>
  )
}
