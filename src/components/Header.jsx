  ...
  return (
    <header className="sticky top-0  z-[100] overflow-hidden w-full ">
      <div className="header-wrapper relative flex items-center justify-between bg-[#242424] lg:bg-gradient-to-r from-black via-gray-900 to-gray-800 px-6 py-4">
        ...
        <div ref={menuRef} className={`mobile-menu  overflow-hidden absolute opacity-0 top-[-100%]  bg-[#242424] w-full left-0 h-[100vh] lg:hidden `}>
          <div className="relative">
            <div ref={mainMenuRef} className={`main-menu top-[100%] opacity-0 relative transition-[.5s] flex flex-col justify-between px-6 bg-[#242424]  ${subMenu? 'start-[-100%]':'start-[0%]'}`}>
              <ul>
                <li>
                  <Link
                    to="/our-work"
