...
const WolfCard = ({ step, heading, pera, list, quoat, bgColor, textColor, img,className,style,ref }) => {
  return (
    <div ref={ref} style={style} className={` ${className} absolute md:relative px-4 py-12 rounded-xl shadow-lg flex flex-col md:flex-row items-center ${bgColor} ${textColor} w-full`}>
      {/* Image Section */}
