...
const WolfCard = ({ step, heading, pera, list, quoat, bgColor, textColor, img }) => {
  return (
    <div className={`p-6 rounded-xl shadow-lg flex flex-col md:flex-row items-center ${bgColor} ${textColor} w-full`}>
      {/* Image Section */}
